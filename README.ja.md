...
**画像スライドショー:**
```
https://s.cympfh.cc/video?url={IMAGE_URL_1}&url={IMAGE_URL_2}&url={IMAGE_URL_3}&interval={秒数}
```
...
**動画に直接アクセス:**
```
https://s.cympfh.cc/video?url=y!cats!0    # 最初の結果
https://s.cympfh.cc/video?url=y!cats!1    # 2番目の結果
```
